      ...
      <section className="relative py-24 overflow-hidden min-h-[50vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Developer working on system"
            className="w-full h-full object-cover"
          />
        ...
        <div className="relative z-10 container-custom text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
            Ready to Build Something <span className="text-orange-400">Amazing</span>?
          </h2>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 bg-orange-500 text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-orange-600 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-orange-500/25"
            >
              Let's Talk <ArrowRight size={18} />
            </Link>
            <Link
              to="/projects"
              className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20"
            >
              View My Work
            </Link>
          </div>
